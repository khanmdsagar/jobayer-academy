...
<div style="line-height: 1; font-size: 17px;" class="as-p-10px">
    <div onclick="window.location.href='/admin/dashboard'"
        ...
        <div class="as-ml-10px">Dashboard</div>
    </div>
    <div onclick="window.location.href='/admin/asked-question'"
        class="as-flex as-align-center as-list-hover as-p-10px as-app-cursor as-brr-5px">
        <svg width="22px" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
            <path
        ...
        <div class="as-ml-10px">Asked Question</div>
    </div>
    <div onclick="window.location.href='/admin/category'"
        class="as-flex as-align-center as-list-hover as-p-10px as-app-cursor as-brr-5px">
        <svg width="22px" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
        ...
        <div class="as-ml-10px">Category</div>
    </div>
    <div onclick="window.location.href='/admin/course'"
        class="as-flex as-align-center as-list-hover as-p-10px as-app-cursor as-brr-5px">
        <svg width="22px" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
            <path
        ...
        <div class="as-ml-10px">Course</div>
    </div>
    <div onclick="window.location.href='/admin/student'"
        class="as-flex as-align-center as-list-hover as-p-10px as-app-cursor as-brr-5px">
        <svg width="22px" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
