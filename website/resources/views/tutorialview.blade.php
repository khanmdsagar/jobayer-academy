        ...
        <div class="as-card as-mt-15px as-mb-15px as-p-10px">
            ...
            <div class="as-flex as-justify-end as-align-end">
                <div class="tutorialview-course-progress">
                    ...
                    <span>
                    <span id="course-topic-completed"></span> টি বিষয় সম্পন্ন / <span id="course-topic"></span> টি বিষয়ের মধ্যে
                </span>
                </div>
            </div>
        </div>
            ...
            <div class="as-card as-w-70 md:as-w-100">
                ...
                <div id="tab-container">
                    <div class="tab-buttons as-p-10px">
                        ...
                        <button id="review-btn" class="tab app-cursor" onclick="showModal('review-modal')">রিভিউ দিন</button>
                    </div>
                    ...
                    <div id="tab2" class="tab-content">
                        ...
                        <div class="as-flex as-justify-center">
                            <button id="load-more-qsn-ans" class="as-none as-f-bengali app-cursor as-bg-white as-p-10px as-br-0px">
    ...
    <div id="ask-qsn-modal" class="as-modal" style="display: none">
        <div class="as-modal-child as-bg-white as-p-15px as-m-15px as-brr-5px as-w-50 md:as-w-90">
            ...
            <div class="as-align-end">
                ...
                <button class="as-btn app-cursor as-bg-cancel as-mr-10px" onclick="hideModal('ask-qsn-modal')">বাতিল করুন</button>
            ...
            for (const item of response.data.course_content) {
                ...
                <div class="as-mb-10px">
                    <div class="as-flex as-space-between">
                        ...
                        <span class="as-date as-mr-10px">বিষয় সংখ্যা: ${convertToBengali(item.chapter_topic.length)} টি</span>
                    </div>
                    <div>
